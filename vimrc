...
" unite.vimのキーマップ
" file
nnoremap <silent> [unite]f :<C-u>Unite<Space>-buffer-name=files<Space>file<Space>file/new<CR>
" 今のバッファと同じディレクトリを開く
nnoremap <silent> [unite]g :<C-u>UniteWithBufferDir<Space>-buffer-name=files<Space>file<Space>file/new<CR>
" buffer
...
" typescriptはtsuquyomi + tslintでチェック
...
" Ctrl + Spaceでオムニ補完
" 入力モードの時のみに効かせる
" http://d.hatena.ne.jp/dgdg/20080109/1199891258
imap <Nul> <C-x><C-o>

" :Rename で現在編集中のファイル名を変更する
